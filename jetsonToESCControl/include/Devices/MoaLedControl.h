 ...
 */
enum MoaLedIndex {
    LED_INDEX_TEMP = MCP_PIN_LED_TEMP,
    LED_INDEX_OVERCURRENT = MCP_PIN_LED_OVERCURRENT,
    LED_INDEX_BATT_LOW = MCP_PIN_LED_BATT_LOW,
    LED_INDEX_BATT_MED = MCP_PIN_LED_BATT_MED,
    LED_INDEX_BATT_HI = MCP_PIN_LED_BATT_HI,
};
